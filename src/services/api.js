...
export async function analyzeGrid(grid) { try{const{data}=await api.post("/puzzle/analyze",{grid});return data;}catch{return{symmetry_score:0,entropy:0,is_perfect_palindrome:false,pater_noster_found:false,letter_distribution:{}};} }
...
export async function fetchSites() {
  try{const{data}=await api.get("/sites");return data;}catch{
    return[
